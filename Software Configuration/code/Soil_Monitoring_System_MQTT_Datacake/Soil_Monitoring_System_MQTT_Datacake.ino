...
// Digital Output pin to transistor
int nMOSFET = 25;
...
void loop()
{
  ...
  // Pull the pin connected to transistor HIGH to turn it on
  digitalWrite(nMOSFET, HIGH);
  ...
  // Pull the pin connected to transistor LOW to turn it off
  digitalWrite(nMOSFET, LOW);
